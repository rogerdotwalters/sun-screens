...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const toEmail   = env.NOTIFY_EMAIL || 'rogerwalters3@gmail.com';
    const fromEmail = env.FROM_EMAIL   || 'noreply@sun-screens.com';
    const fromName  = env.FROM_NAME    || 'Sun Screens Website';
